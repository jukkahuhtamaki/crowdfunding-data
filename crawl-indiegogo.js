...
console.log('Click #' + clicks); this.click(x("//a[text()='show more']")); clicks += 1; fs.write('data/01-raw/investments-sondor-click'
+ ('00000' + clicks).slice (-5) + '.html', this.getHTML('desktop-funders'), 'w');
